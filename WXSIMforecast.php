        ...
        function printAdminPage() {
                    ...
                    if (isset($_POST['update_WXSIMForecastSettings'])) {
						...
						if (isset($_POST['WXSIMshowheatidx'])) {
                            $devOptions['showheatidx'] = $_POST['WXSIMshowheatidx'];
                        } 
						if (isset($_POST['WXSIMshowHotIconF'])) {
                            $devOptions['showHotIconF'] = $_POST['WXSIMshowHotIconF'];
                        } 
						if (isset($_POST['WXSIMshowHotIconC'])) {
                            $devOptions['showHotIconC'] = $_POST['WXSIMshowHotIconC'];
                        } 
						if (isset($_POST['WXSIMshowWindChill'])) {
                            $devOptions['showWindChill'] = $_POST['WXSIMshowWindChill'];
                        } 
						if (isset($_POST['WXSIMshowColdvalF'])) {
                            $devOptions['showColdvalF'] = $_POST['WXSIMshowColdvalF'];
                        } 
						if (isset($_POST['WXSIMshowColdvalC'])) {
                            $devOptions['showColdvalC'] = $_POST['WXSIMshowColdvalC'];
                        }
                        if (isset($_POST['WXSIMuomTemp'])) {
                            $devOptions['uomTemp'] = $_POST['WXSIMuomTemp'];
                        } 	
                        if (isset($_POST['WXSIMourTZ'])) {
                            $devOptions['ourTZ'] = $_POST['WXSIMourTZ'];
                        } 								
						if (isset($_POST['WXSIManimatedimage'])) {
                            $devOptions['animatedimage'] = apply_filters('content_save_pre', $_POST['WXSIManimatedimage']);
                        } 
                        ...
                        <h3>Show Hot icon if Heat-Index >= value (Fahrenheit)</h3>
						<p>Heat Icon will be displayed if the value is equal to or greater than the value entered (Fahrenheit)</p>
						<textarea name="WXSIMshowHotIconF" style="width: 10%; height: 30px;"><?php _e(apply_filters('format_to_edit',$devOptions['showHotIconF']), 'WXSIMForecast') ?></textarea>

						<h3>Show Hot icon if Heat-Index >= value (Celcius)</h3>
						<p>Heat Icon will be displayed if the value is equal to or greater than the value entered (Celcius)</p>
						<textarea name="WXSIMshowHotIconC" style="width: 10%; height: 30px;"><?php _e(apply_filters('format_to_edit',$devOptions['showHotIconC']), 'WXSIMForecast') ?></textarea>
						
						<h3>Show Windchill?</h3>
                        <p>Selecting "No" will disable Windchill from being displayed.</p>
                        <p><label for="WXSIMshowWindChill_true"><input type="radio" id="WXSIMshowWindChill_true" name="WXSIMshowWindChill" value="true"
						<?php if ($devOptions['showWindChill'] == "true") { _e('checked="checked"', "WXSIMForecast"); }?> /> Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;
						<label for="WXSIMshowWindChill_false"><input type="radio" id="WXSIMshowWindChill_false" name="WXSIMshowWindChill" value="false"
						<?php if ($devOptions['showWindChill'] == "false") { _e('checked="checked"', "WXSIMForecast"); }?>/> No</label></p>
						
						<h3>Show Cold! if Wind-Chill <= value (Fahrenheit)</h3>
						<p>Cold Icon will be displayed if the value is less than or greater than the value entered (Fahrenheit)</p>
						<textarea name="WXSIMshowColdvalF" style="width: 10%; height: 30px;"><?php _e(apply_filters('format_to_edit',$devOptions['showColdvalF']), 'WXSIMForecast') ?></textarea>
						
						<h3>Show Cold! if Wind-Chill <= value (Celcius)</h3>
						<p>Cold Icon will be displayed if the value is less than or greater than the value entered (Celcius)</p>
						<textarea name="WXSIMshowColdvalC" style="width: 10%; height: 30px;"><?php _e(apply_filters('format_to_edit',$devOptions['showColdvalC']), 'WXSIMForecast') ?></textarea>
						
						<h3>UOM Temperature</h3>
						<p>Selecting either &deg;C or &deg;F this value should match forecast temperature</p>
						<p><label for="WXSIMuomTemp_C"><input type="radio" id="WXSIMuomTemp_C" name="WXSIMuomTemp" value="C" 
						<?php if ($devOptions['uomTemp'] == "C") { _e('checked="checked"', "WXSIMForecast"); }?> /> &deg;C</label>&nbsp;&nbsp;&nbsp;&nbsp;
						<label for="WXSIMuomTemp_F"><input type="radio" id="WXSIMuomTemp_F" name="WXSIMuomTemp" value="F" 
						<?php if ($devOptions['uomTemp'] == "F") { _e('checked="checked"', "WXSIMForecast"); }?>/> &deg;F</label></p>
						
						<h3>Language</h3>
						<p>Please enter your timezone (http://php.net/manual/en/timezones.america.php)</p>
						<textarea name="WXSIMourTZ" style="width: 10%; height: 30px;"><?php _e(apply_filters('format_to_edit',$devOptions['ourTZ']), 'WXSIMForecast') ?></textarea>
						
						<h3>Show Animated images?</h3>
                        <p>Selecting "No" will show static images and selecting "Yes" will show animated images.</p>
                        <p><label for="WXSIManimatedimage_yes"><input type="radio" id="WXSIManimatedimage" name="WXSIManimatedimage" value="true" 
						<?php if ($devOptions['animatedimage'] == "true") { _e('checked="checked"', "WXSIMForecast"); }?> /> Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;
						<label for="WXSIManimatedimage_no"><input type="radio" id="WXSIManimatedimage_no" name="WXSIManimatedimage" value="false" 
						<?php if ($devOptions['animatedimage'] == "false") { _e('checked="checked"', "WXSIMForecast"); }?>/> No</label></p>
...
function WXSIMforecast_func( $atts) {
...
$showHotIconF = $WXSIMOptions['showHotIconF'];                     // show Hot icon if Heat-Index >= value
$showHotIconC = $WXSIMOptions['showHotIconC'];                                               // show Hot icon if Humidex >= value

$showWindChill = true;                                              // =true to display Wind-Chill, =false to suppress display
if ($WXSIMOptions['showWindChill'] == "true") {$showWindChill = true;}
$showColdvalF = $WXSIMOptions['showColdvalF'];                      // show Cold! if Wind-Chill <= value in F
$showColdvalC = $WXSIMOptions['showColdvalC'];                      // show Cold! if Wind-Chill <= value in C
$uomTemp   = $WXSIMOptions['uomTemp'];                        // ='C' if forecast temperature in Centigrade, ='F' if in Fahrenheit
...
if ($WXSIMOptions['animatedimage'] == "true") {$iconType = '.gif';}
...
if ($doTranslate and file_exists("./wp-content/plugins/wxsim-forecast/plaintext-parser-lang-$lang.txt") ) {
...
<p><small><a href="http://www.wxsim.com/">WXSIM</a> 
<?php echo PPget_lang("forecast formatting script by");?>
<a href="http://saratoga-weather.org/scripts.php"> Saratoga-Weather.org</a>
<?php if($iconType <> '.jpg') {
    print "<br/>";
    echo PPget_lang("Animated forecast icons courtesy of"); 
	print " <a href=\"http://www.meteotreviglio.com/\">www.meteotreviglio.com</a>.";
} 
?>
